...
?>
    <div class="row">
        <div class="col-lg-3">
            <a href="index.php?r=itemrecieve/recieveqr" target="_self" class="btn btn-primary"><i class="fa fa-camera"></i>
                สแกน
                QR Code</a>
        </div>
    </div>
    <br/>
    <form id="save-issue" method="post" action="<?=\yii\helpers\Url::to(['itemrecieve/createfromqr'],true)?>">
        <div class="row">
            <div class="col-lg-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <input type="number" id="lot-recieve-qty" name="recieve_qty" class="form-control" value="0" min="1" onchange="">
                <div class="alert-qty alert alert-danger" style="display: none;top: 5px;">จำนวนมากกว่าจำนวนขั้นต่ำ</div>
            </div>
            <div class="col-lg-3">
                <label for="">วันหมดอายุ</label>
                <input type="text" class="form-control lot-expired-date" value="" name="lot_expired_date">
            </div>
        </div>
        <br/>
        <div class="row">
            ...
            <div class="col-lg-3">
                <label for="">เลขใบเบิก</label>
                <input type="text" class="form-control" value="" name="issue_ref_no">
            </div>
        </div>
        <br/>
        <div class="row">
            <div class="col-lg-3">
                <input type="submit" class="btn btn-success btn-save" value="บันทึกรับยา">
            </div>
        </div>
    </form>
...
$(function(){
     ...
     $('.lot-expired-date').datepicker({'format': 'dd-mm-yyyy'});
